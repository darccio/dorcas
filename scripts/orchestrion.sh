WORK=/var/folders/jz/200n23xd7fd94f51mt3787qm0000gn/T/go-build4199349655
mkdir -p $WORK/b001/
cat >/var/folders/jz/200n23xd7fd94f51mt3787qm0000gn/T/go-build4199349655/b001/importcfg << 'EOF' # internal
# import config
...
/Users/dario.castane/go/bin/orchestrion toolexec /opt/homebrew/Cellar/go/1.25.0/libexec/pkg/tool/darwin_arm64/compile -o $WORK/b001/_pkg_.a -trimpath "$WORK/b001=>" -p main -lang=go1.25 -complete -buildid hwjsdBsjH_hNL2jE2sVv/hwjsdBsjH_hNL2jE2sVv -goversion go1.25.0 -c=4 -shared -nolocalimports -importcfg $WORK/b001/importcfg -pack ./main.go
go tool buildid -w $WORK/b001/_pkg_.a # internal
cp $WORK/b001/_pkg_.a /Users/dario.castane/Library/Caches/go-build/12/12ac086e082dc6c835dfaa634a63e9ddff1564506bf98577584f37435d19536c-d # internal
cat >/var/folders/jz/200n23xd7fd94f51mt3787qm0000gn/T/go-build4199349655/b001/importcfg.link << 'EOF' # internal
packagefile command-line-arguments=/var/folders/jz/200n23xd7fd94f51mt3787qm0000gn/T/go-build4199349655/b001/_pkg_.a
packagefile fmt=/Users/dario.castane/Library/Caches/go-build/03/0364df70131745b90254842c4ddab8e8ea1330f75530fb38129333a4c013dbe7-d
packagefile runtime=/Users/dario.castane/Library/Caches/go-build/91/9141075a755aad2bcfc7ec465820e91d677fa5825bba0b66e282703164a6e7e7-d
...
cd .
GOROOT='/opt/homebrew/Cellar/go/1.25.0/libexec' /Users/dario.castane/go/bin/orchestrion toolexec /opt/homebrew/Cellar/go/1.25.0/libexec/pkg/tool/darwin_arm64/link -o $WORK/b001/exe/a.out -importcfg $WORK/b001/importcfg.link -buildmode=pie -buildid=UQwR1Q3jJJkSQLMg_3xK/hwjsdBsjH_hNL2jE2sVv/dXFxo_Qcus9eZFY6v0jb/UQwR1Q3jJJkSQLMg_3xK -extld=cc $WORK/b001/_pkg_.a
